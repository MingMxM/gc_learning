...
// Domain: 25 m (x, width = fracture spacing) x 150 m (y, well spacing).
...
// ---- parameters ----
W  = 25.0;    // width  (x) = matrix sweep distance (fracture spacing)
H  = 150.0;   // height (y)
...
nx_mid   = 34;     // cells across 25 m matrix, refined toward both walls
...
Transfinite Curve {2,5,8,11}    = nx_mid + 1 Using Bump 0.06;        // matrix: refined toward BOTH walls, coarser middle
