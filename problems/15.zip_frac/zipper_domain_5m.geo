...
// Domain: 5 m (x, width = fracture spacing) x 150 m (y, well spacing).
...
// ---- parameters ----
W  = 5.0;     // width  (x) = matrix sweep distance (fracture spacing)
H  = 150.0;   // height (y)
...
nx_mid   = 24;     // cells across 5 m matrix, refined toward both walls
