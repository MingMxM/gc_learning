...
// Domain: 25 m (x, width = zipper offset) x 150 m (y, well spacing).
...
nx_mid   = 36;     // cells across 50 m matrix, strongly refined toward walls only
...
Transfinite Curve {2,5,8,11}    = nx_mid + 1 Using Bump 0.03;        // matrix: strongly refined toward BOTH walls, coarse middle
